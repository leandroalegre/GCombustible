    ...
    <div class="container">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-md-12">
						<h1>SOLICITUDES EMITIDAS</h1>
						<strong><small><?php echo $this->session->userdata("nombre_secretaria") ?></small></strong>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-hover" id="tablaTE">
                                ...
                                <tbody>
                                    <?php foreach ($solicitudes as $s): ?>
                                        <tr>
										<td style="vertical-align: middle;"><?php echo $s->marca;?></td>
										<td style="vertical-align: middle;"><?php echo $s->modelo;?></td>
                                            ...
                                            <?php }else if($s->estado_soli=="Rechazado"){?>
                                                <td style="vertical-align: middle; color: red;"><?php echo $s->estado_soli;?></td>
											<?php }else{ ?>
												<td style="vertical-align: middle; color: blue"><?php echo $s->estado_soli;?></td>
												<?php } ?>
